...
#sleep(4)
ovs-vsctl set-controller rsu9 tcp:127.0.0.1:6653
#ovs-vsctl set controller rsu9 connection-mode=out-of-band
#ovs-vsctl set-fail-mode rsu9 secure
ifconfig rsu9-wlan1 10.0.2.82/24
