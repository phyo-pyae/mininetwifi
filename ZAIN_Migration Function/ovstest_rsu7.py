#OVS-CONNECTION for RSU7Test with C1:
ovs-vsctl set-controller rsu7 tcp:127.0.0.1:6651
#ovs-vsctl set controller rsu7 connection-mode=out-of-band
#ovs-vsctl set-fail-mode rsu7 secure
ifconfig rsu7-wlan1 10.0.2.12/24
#sleep(4)
